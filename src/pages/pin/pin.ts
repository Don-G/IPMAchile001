...
export class Pin {
  ...
  constructor(private device: Device, public platform: Platform, public navCtrl: NavController, public dbService: DbService, public modalCtrl: ModalController, public events: Events, storage: Storage, public alertCtrl: AlertController, public navParams: NavParams) {
    this.new_pin = "";
